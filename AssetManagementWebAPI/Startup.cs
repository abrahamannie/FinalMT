...
namespace AssetManagementWebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AssetManagementDbContext>(item =>
          item.UseSqlServer(Configuration.GetConnectionString("AssetConnection")));

            services.AddScoped<ILoginRepository, LoginRepository>();
            services.AddScoped<IUserRegRepository, UserRegRepository>();
